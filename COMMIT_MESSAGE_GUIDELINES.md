...
This approach is highly recommended as it remains fully compliant with automated changelog generator tools (which expect the line to start strictly with the prefix `type:`).
