...
- Make sure to make PR against `dev` and not `master`.
...
- [ ] I have read the [CONTRIBUTING](https://github.com/robert-flo/bare-minimun/blob/master/CONTRIBUTING.md) document.
- [ ] My code follows the code style of this project.
- [ ] My commit message follows the [commit guidelines](https://github.com/robert-flo/bare-minimun/blob/master/COMMIT_MESSAGE_GUIDELINES.md).
